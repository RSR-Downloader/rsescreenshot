...
async def feedback(client, message):
    await client.send_message(
        chat_id=message.chat.id,
        text=f"for suggetions and feedbacks contact @rsr_help_bot",
        reply_to_message_id=message.message_id
    )
...
async def about(client, message):
    await client.send_message(
        chat_id=message.chat.id,
        text='This bot is created by @rsrmusic ©️ @mizolibrary as a project\n\n Thanks to <a href="https://t.me/rsrtginfo"></a> and <a href="https://youtube.com/c/ArtInMirror"</a> for helping me ',
